...
def generate_launch_description():
    ...
    # Map fully qualified names to relative ones so the node's  can be prepended.
    ...
    declare_launch_localization_nodes_cmd = DeclareLaunchArgument('launch_localization_nodes',default_value='False',
            description='launch localization nodes')
    declare_map_file_cmd=DeclareLaunchArgument('map_file',default_value='',description='save map file')

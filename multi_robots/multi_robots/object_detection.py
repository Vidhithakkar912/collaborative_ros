...
class PoseEstimation(Node):
    ...
    def __init__(self):
        ...
        self.model = YOLO("/home/vidhi123/tb3_ws/src/multi_robots/cardbox/runs/detect/box_detector/best.pt")
        ...
        rgb_topic     = f"{prefix}/camera/image_raw"
        caminfo_topic = f"{prefix}/camera/depth/camera_info"
        pose_topic    = f"{prefix}/box_poses"
        

        
        self.optical_frame_ = f"{ns}/camera_depth_frame"

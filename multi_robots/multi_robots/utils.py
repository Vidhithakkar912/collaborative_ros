...
def load_sdf_with_namespace(model_path, namespace):
    ...
    topic_map = {
        ...
        # Depth camera
        '<topic>camera/depth/image_raw</topic>':f'<topic>/{namespace}/camera/depth/image_raw</topic>',
        '<camera_info_topic>camera/depth/camera_info</camera_info_topic>':f'<camera_info_topic>/{namespace}/camera/depth/camera_info</camera_info_topic>',
    }
